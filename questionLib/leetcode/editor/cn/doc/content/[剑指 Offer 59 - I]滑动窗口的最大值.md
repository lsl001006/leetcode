...
<pre><strong>输入:</strong> <em>nums</em> = <span><code>[1,3,-1,-3,5,3,6,7]</code></span>, 和 <em>k</em> = 3
...
<div><div>Related Topics</div><div><li>队列</li><li>滑动窗口</li><li>单调队列</li><li>堆（优先队列）</li></div></div><br><div><li>👍 460</li><li>👎 0</li></div>